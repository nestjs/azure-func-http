...
describe('Schematic Tests Nest Add', () => {
    ...
    it('should handle nest add for default app', async () => {
        ...
        const tree = await runner.runSchematicAsync('nest-add', options, nestTree).toPromise();
    ...
    it('should handle nest add for project', async () => {
        ...
        await runner.runExternalSchematicAsync('@nestjs/schematics', 'library', {
            name: 'lib1',
            prefix: '@app'
        }, nestTree).toPromise();
    ...
    async function createTestNest(runner: SchematicTestRunner, appOptions = {}, tree?: Tree):
        Promise<UnitTestTree> {
        return await runner.runExternalSchematicAsync('@nestjs/schematics', 'application', {
            name: 'newproject',
            directory: '.'
        }, tree).toPromise();
    }
